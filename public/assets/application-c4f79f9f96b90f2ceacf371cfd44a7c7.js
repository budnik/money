...
(function() {
  window.Money = {
    ...
    initialize: function() {
      ...
      this.crr_router = new Money.Routers.Currencies;
      this.trp_router = new Money.Routers.Trips;
  ...
  $(document).ready(function() {
    ...
    return $(document).on("click", "a", function(event) {
      ...
      if ($(event.currentTarget).attr('data-dismiss')) {
        return;
      }
...
(function() {
  ...
  window.JST['countries/country'] = function(context) {
    return (function() {
      var $c, $e, $o, klass;
      ...
      $o = [];
      klass = this.get('visited') ? 'important visited-countries' : 'inverse';
      $o.push("<div class='" + (['label', "label-" + ($e($c(klass)))].sort().join(' ').replace(/^\s+|\s+$/g, '')) + "'>");
      $o.push("  " + $e($c(this.get("name"))));
      if (this.get('visited')) {
        $o.push("  *");
      }
      $o.push("</div>");
...
(function() {
  ...
  window.JST['countries/index'] = function(context) {
    return (function() {
      ...
      $o = [];
      $o.push("<h5>");
      $o.push("  " + $e($c(this.currency_code)));
      $o.push("  available in following countries:\n</h5>\n<p></p>");
      if ((_ref1 = this.visitedIds) != null ? _ref1.length : void 0) {
        $o.push("<div class='visited-countries'>\n  <hr>\n  <span class='pull-right'>\n    *You have already visited this country.\n    <a href='#' data-dismiss='visited-countries'>hide it</a>\n  </span>\n</div>");
      }
      return $o.join("\n").replace(/\s(\w+)='true'/mg, ' $1').replace(/\s(\w+)='false'/mg, '').replace(/\s(?:id|class)=(['"])(\1)/mg, "");
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  window.JST['countries/visited_sidebar_item'] = function(context) {
    return (function() {
      ...
      $c = window.HAML.cleanValue;
      $o = [];
      $o.push("<li class='visited-country'>\n  <a href='/countries/" + ($e($c(this.get('code')))) + "'>" + ($e($c(this.get('name')))) + "</a>\n</li>");
      return $o.join("\n").replace(/\s(\w+)='true'/mg, ' $1').replace(/\s(\w+)='false'/mg, '').replace(/\s(?:id|class)=(['"])(\1)/mg, "");
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  window.JST['currencies/index'] = function(context) {
    return (function() {
      ...
      $o = [];
      $o.push("<table class='table table-bordered table-hover table-striped'>\n  <thead></thead>\n  <tbody></tbody>\n</table>");
      return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  window.JST['currencies/placeholder'] = function(context) {
    return (function() {
      var $o;
...
(function() {
  ...
  window.JST['currencies/row'] = function(context) {
    return (function() {
      var $c, $e, $o;
      ...
      $c = window.HAML.cleanValue;
      $o = [];
      $o.push("<td>" + ($e($c(this.get('code')))) + "</td>\n<td>" + ($e($c(this.get('name')))) + "</td>");
...
(function() {
  ...
  window.JST['trips/trip'] = function(context) {
    return (function() {
      var $c, $e, $o;
      ...
      $c = window.HAML.cleanValue;
      $o = [];
      $o.push("<td>" + ($e($c(this.get("date")))) + "</td>\n<td>" + ($e($c(this.get("description")))) + "</td>");
      return $o.join("\n").replace(/\s(\w+)='true'/mg, ' $1').replace(/\s(\w+)='false'/mg, '');
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  Money.Models.Country = (function(_super) {
    ...
    Country.prototype.get = function(attr) {
      var value;

      return value = (typeof this[attr] === "function" ? this[attr]() : void 0) || Backbone.Model.prototype.get.call(this, attr);
    };

    Country.prototype.visited = function() {
      return _.contains(this.collection.visitedIds, this.get('id'));
    };
...
(function() {
  ...
  Money.Collections.Countries = (function(_super) {
    ...
    Countries.prototype.visitedIds = [];
...
(function() {
  ...
  Money.Views.CountriesInCell = (function(_super) {
    __extends(CountriesInCell, _super);

    function CountriesInCell() {
      _ref = CountriesInCell.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    CountriesInCell.prototype.eachTemplate = JST['countries/country'];

    CountriesInCell.prototype.tagName = 'td';

    CountriesInCell.prototype.render = function() {
      this.$el.html(this.collection.map(this.eachTemplate).join(' '));
      return this;
    };

    return CountriesInCell;
...
(function() {
  ...
  Money.Views.CountriesIndex = (function(_super) {
    ...
    CountriesIndex.prototype.eachTemplate = JST['countries/country'];

    CountriesIndex.prototype.template = JST['countries/index'];

    CountriesIndex.prototype.className = 'well';

    CountriesIndex.prototype.events = {
      'click a': 'removeVisited'
    };

    CountriesIndex.prototype.render = function() {
      this.$el.html(this.template(this.collection));
      this.$('p').html(this.collection.map(this.eachTemplate).join());
      return this;
    };

    CountriesIndex.prototype.removeVisited = function(e) {
      console.log(e, this);
      e.preventDefault();
      return this.$('.visited-countries').remove();
    };
...
(function() {
  ...
  Money.Views.CurrenciesIndex = (function(_super) {
    ...
    CurrenciesIndex.prototype.className = 'span4 offset1';

    CurrenciesIndex.prototype.id = 'main-content';

    CurrenciesIndex.prototype.template = JST['currencies/index'];

    CurrenciesIndex.prototype.render = function() {
      var tbody,
        _this = this;

      tbody = this.$el.html(this.template).find('tbody');
      this.collection.each(function(model) {
        var view;

        view = new Money.Views.CurrencyRow({
          model: model
        });
...
(function() {
  ...
  Money.Views.CurrencyRow = (function(_super) {
    __extends(CurrencyRow, _super);

    function CurrencyRow() {
      _ref = CurrencyRow.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    CurrencyRow.prototype.className = 'currency';

    CurrencyRow.prototype.tagName = 'tr';

    CurrencyRow.prototype.template = JST['currencies/row'];

    CurrencyRow.prototype.events = {
      'click': 'showCountries'
    };

    CurrencyRow.prototype.render = function() {
      this.$el.html(this.template(this.model));
      return this;
    };

    CurrencyRow.prototype.showCountries = function(e) {
      var countries, view;

      countries = new Money.Collections.Countries(this.model.get("countries"));
      countries.visitedIds = this.model.get('visited_countries_ids');
      countries.currency_code = this.model.get('code');
      view = new Money.Views.CountriesIndex({
        collection: countries
      });
      return $('#sidebar-nav').html(view.render().el);
    };
...
(function() {
  ...
  Money.Views.Placeholder = (function(_super) {
    ...
    Placeholder.prototype.className = 'affix';

    Placeholder.prototype.id = 'sidebar-nav';

    Placeholder.prototype.template = JST['currencies/placeholder'];
...
(function() {
  ...
  Money.Views.Trip = (function(_super) {
    __extends(Trip, _super);
    ...
    Trip.prototype.tagName = 'tr';

    Trip.prototype.className = 'trip';

    Trip.prototype.template = JST['trips/trip'];
...
(function() {
  ...
  Money.Views.TripsIndex = (function(_super) {
    ...
    TripsIndex.prototype.id = 'main-content';

    TripsIndex.prototype.template = JST['trips/index'];

    TripsIndex.prototype.newTripTemplate = JST['trips/new_trip'];

    TripsIndex.prototype.events = {
      'click button#new-trip': 'newTrip',
      'submit': 'ajaxSubmit'
    };

    TripsIndex.prototype.render = function() {
      var tbody,
        _this = this;

      tbody = this.$el.html(this.template).find('tbody');
      this.collection.each(function(model) {
        var countries, cview, view;

        view = new Money.Views.Trip({
          model: model
        });
        if (model.get("countries").length > 0) {
          countries = new Money.Collections.Countries(model.get("countries"));
          cview = new Money.Views.CountriesInCell({
            collection: countries
          });
        ...
        return $(view.render().el).appendTo(tbody).append(cview);
      });
      return this;
    };

    TripsIndex.prototype.newTrip = function() {
      return this.$('tbody').append(this.newTripTemplate);
    };

    TripsIndex.prototype.ajaxSubmit = function(e) {
      var _this = this;
      ...
      return $.ajax({
        ...
        success: function() {
          _this.collection.trigger('updated');
          return Backbone.history.navigate('/trips');
        }
      });
    };
...
(function() {
  ...
  Money.Routers.Currencies = (function(_super) {
    ...
    Currencies.prototype.routes = {
      'currencies': 'index'
    };

    Currencies.prototype.index = function() {
      var collection;
      ...
      return collection.fetch().success(function() {
        ...
        view = new Money.Views.CurrenciesIndex({
          collection: collection
        });
        $('#main-content').replaceWith(view.render().el);
        placeholder = new Money.Views.Placeholder;
        return $('#sidebar-nav').replaceWith(placeholder.render().el);
      });
    };
...
(function() {
  ...
  Money.Routers.Trips = (function(_super) {
    ...
    Trips.prototype.index = function() {
      var collection;
      ...
      return collection.fetch().success(function() {
        ...
        view = new Money.Views.TripsIndex({
          collection: collection
        });
        $('#main-content').replaceWith(view.render().el);
        return $('#sidebar-nav').replaceWith('');
      });
    };
